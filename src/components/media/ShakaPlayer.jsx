...
export default function ShakaPlayer({ src, title, onClose, onProgress, startAt = 0 }) {
  ...
  if (error) {
    return (
      <div className="fixed inset-0 z-50 bg-black flex flex-col items-center justify-center gap-4">
        ...
        <button onClick={onClose} className="px-4 py-2 bg-primary text-white rounded-lg text-sm">Close</button>
      </div>
    );
  }
