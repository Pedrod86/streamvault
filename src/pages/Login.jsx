    ...
    return (
      ...
      >
        ...
        <div style={{ width: '100%', maxWidth: 460, padding: '24px', backgroundColor: 'hsl(217 33% 17%)' }}
          ...
          <Button
            variant="outline"
            className="w-full h-12 border-border rounded-xl font-medium text-base tv-focusable"
            tabIndex={4}
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-white/10 backdrop-blur-2xl shadow-2xl p-6 sm:p-8"
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs"><span className="bg-transparent px-2 text-muted-foreground">or</span></div>
          </div>

          <Button variant="outline" className="w-full h-11 border-white/10 bg-white/5 rounded-xl font-medium" onClick={handleGoogle}>
          ...
          <Button variant="outline" className="w-full h-11 border-white/10 bg-white/5 rounded-xl font-medium mt-3" onClick={handleApple}>
          ...
          <Button variant="outline" className="w-full h-11 border-white/10 bg-white/5 rounded-xl font-medium mt-3" onClick={handleFacebook}>
          ...
          <Button variant="outline" className="w-full h-11 border-white/10 bg-white/5 rounded-xl font-medium mt-3" onClick={handleMicrosoft}>
